...
namespace AracKiralama
{
    public partial class FrmEditCars : Form
    {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            // Controls
            int a = TxtRenter.Text.IndexOf(' ');
            string name = SqlDatabase.GetColumn(SqlDatabase.dbAracKiralama, SqlDatabase.tbCustomers, "Name", 1, "Name" , TxtRenter.Text.Substring(0, a))[0];
            ...
            string command = "USE AracKiralama UPDATE Cars SET Price = " + TxtPrice.Text + ", Model = " + TxtNewModel.Text + 
                ...
                ", AutoGear = " + ChbAutoGear.Checked.ToString() + ", Rented = " + ChbRented.Checked.ToString() + 
                ", Damaged = " + ChbDamaged.Checked.ToString() + ", Delivered = " + ChbDelivered.Checked.ToString() +
