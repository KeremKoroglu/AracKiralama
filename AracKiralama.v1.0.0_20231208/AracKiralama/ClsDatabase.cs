...
namespace AracKiralama
{
    public class ClsDatabase
    {
        ...
        readonly SqlConnection con = new SqlConnection("Data Source=fdestj15;Initial Catalog=AracKiralama;User ID=keremkoroglu;Password=User1234user...;Integrated Security=SSPI;Integrated Security=False");
        SqlCommand cmd;
        SqlDataReader dr;
