...
namespace AracKiralama
{
    public class ClsSqlDatabase
    {
        ...
        // Search -- Ara // EditCars'da Arayınca, Bunu mu demek istediniz? gibi bir sorgu için
        public string[] Search(string Db, string Tb, string Column, string Type, byte ConditionCount = 0, string Condition = "", string Value = "")
        {
            ConOpen();
            int i = 0;
            switch (Type)
            {
                case "/%":
                    ...
                    int Count = GetColumnCount(Db, Tb, Type, ConditionCount, Condition, Value);
                ...
                case "%/":
                    ...
                    Count = GetColumnCount(Db, Tb, Type, ConditionCount, Condition, Value);
