...
namespace AracKiralama
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            /*Bu değer toplam satır sayısından alındı*/LblTotalCar.Text = "Toplam Araba : " + Database.ColumnCount(Database.dbAracKiralama ,Database.tbCars, "=", 0, "0", "0");
            LblIdleCar.Text = "Boşta Araba : " + Database.ColumnCount(Database.dbAracKiralama, Database.tbCars, "=", 1, "Rented", "0");
            LblRentedCar.Text = "Kiralanan Araba : " + Database.ColumnCount(Database.dbAracKiralama, Database.tbCars, "=", 1, "Rented", "1");
        }
