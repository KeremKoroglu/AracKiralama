...
namespace AracKiralama
{
    public class ClsSqlDatabase
    {
        ...
        public int ColumnCount(string Db, string Tb, string Type = "=", byte ConditionCount = 0, string Condition = "", string Value = "")
        {
            try
            {
                int Count;
        ...
        public string[] GetColumn(string Db, string Tb, string Column, byte ConditionCount = 0, string Condition = "", string Value = "")
        {
            ...
            {
                int i = 0;
                int columnCount = ColumnCount(Db, Tb, "=", ConditionCount, Condition, Value);
