...
namespace AracKiralama
{
    public partial class FrmEditCustomers : Form
    {
        ...
        private void BtnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                string search;
                string searchName = DatabaseManage.Search(sqlDatabase.tbCustomers, "Name", "%%", ("Name", name))[0] == "" ? null : DatabaseManage.Search(sqlDatabase.tbCustomers, "Name", "%%", ("Name", name))[0];
                string searchSurname = DatabaseManage.Search(sqlDatabase.tbCustomers, "Surname", "%%", ("Surname", surname))[0] == "" ? null : DatabaseManage.Search(sqlDatabase.tbCustomers, "Surname", "%%", ("Surname", surname))[0];
                ...
                {
                    MessageBox.Show("Müşteri Bulunamadı! \nLütfen ismi veya soyismi doğru girdiğinizden emin olun.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        private void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string lastRentedModel = CmbLastRentedModel.Text == "Yok" ? null : CmbLastRentedModel.Text;
        ...
        private void CmbID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            CmbLastRentedModel.Text = string.IsNullOrEmpty(DatabaseManage.GetColumn(sqlDatabase.tbCustomers, "LastRentedModel", ("Id", CmbID.Text))[0]) == true ? "Yok" : DatabaseManage.GetColumn(sqlDatabase.tbCustomers, "LastRentedModel", ("Id", CmbID.Text))[0];
        ...
        void GetValues()
        {
            ...
            // Write CmbLastRentedModel
            CmbLastRentedModel.Items.Clear();
            CmbLastRentedModel.Items.Add("Yok");
            foreach (string item in DatabaseManage.GetColumn(sqlDatabase.tbCars, "Model"))
            {
                CmbLastRentedModel.Items.Add(item);
            }
            CmbLastRentedModel.SelectedItem = "Yok";
            if (!string.IsNullOrEmpty(DatabaseManage.GetColumn(sqlDatabase.tbCustomers, "LastRentedModel", ("Id", CmbID.Text))[0]))
            {
                CmbLastRentedModel.SelectedItem = DatabaseManage.GetColumn(sqlDatabase.tbCustomers, "LastRentedModel", ("Id", CmbID.Text))[0];
            }
        }
        #endregion
    }
