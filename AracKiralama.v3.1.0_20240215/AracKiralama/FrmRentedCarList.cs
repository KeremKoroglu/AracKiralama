...
namespace AracKiralama
{
    public partial class FrmRentedCarList : Form
    {
        ...
        private void FrmRentedCarList_Activated(object sender, EventArgs e)
        {
            DgvRentedCarList.DataSource = DatabaseManage.GetTable(sqlDatabase.tbCars, ("Rented", "1"));
        }
        private void FrmRentedCarList_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void DgvRentedCarList_RowPostPaint(object sender, DataGridViewRowPostPaintEventArgs e)
        {
