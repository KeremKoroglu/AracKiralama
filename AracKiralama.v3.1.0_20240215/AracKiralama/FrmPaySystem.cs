...
namespace AracKiralama
{
    public partial class FrmPaySystem : Form
    {
        ...
        readonly FrmAddCustomer addCustomer = new();
        #endregion
        ...
        private void BtnNext_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Page == 3)
                {
                    ...
                    if (!ChbPreliminaryInfoForm.Checked || !ChbRentalConditions.Checked)
                    {
                        throw new Exception();
                    }

                    // Pay
                    float newBalance = Convert.ToInt32(databaseManager.GetColumn(sqlDatabase.tbBank, "Balance", ("AccountNumber", "676767"))[0]);
                    newBalance += Total;
                    databaseManager.Update(sqlDatabase.tbBank, "Balance", newBalance.ToString(), ("AccountNumber", "676767"));
                    MessageBox.Show("Ödeme İşlemi Başarılı!", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        // LABEL
        #region Label
        private void LlbPreliminaryInfoForm_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            MessageBox.Show(@"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                "Ön Bilgilendirme Formu", MessageBoxButtons.OK);
        }
        private void LlbRentalConditions_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            MessageBox.Show(@"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                "Kiralama Koşulları", MessageBoxButtons.OK);
        }
        #endregion
        ...
        void GetValues()
        {
            ...
            // TbpCarSelection
            CmbCars.Items.Clear();
            foreach (var item in databaseManager.GetColumn(sqlDatabase.tbCars, "Model", ("Rented", "1")))
            {
                CmbCars.Items.Add(item);
            }
            CmbCars.SelectedIndex = 0;
            CmbCustomers.Items.Clear();
            foreach (var item in databaseManager.GetColumn(sqlDatabase.tbCustomers, "Name", ("Renter", "1")))
            {
        ...
        private void CmbCars_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            CmbCustomers.SelectedItem = databaseManager.GetColumn(sqlDatabase.tbCars, "Renter", ("Model", CmbCars.Text))[0];
        }
        private void CmbCustomers_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            CmbCars.SelectedItem = databaseManager.GetColumn(sqlDatabase.tbCustomers, "RentedModel", ("Name", name), ("Surname", surname))[0];
        }
