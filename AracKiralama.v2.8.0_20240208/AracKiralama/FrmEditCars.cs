...
namespace AracKiralama
{
    public partial class FrmEditCars : Form
    {
        ...
        private void BtnFind_Click(object sender, EventArgs e)
        {
            ...
            {
                string model = DatabaseManage.Search(sqlDatabase.tbCars, "Model", "%%", ("Model", TxtModel.Text))[0];
                if (model != null)
                {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string lastRenter = DatabaseManage.GetColumn(sqlDatabase.tbCars, "Renter", ("Id", CmbID.Text))[0] == "" ? "NULL" : DatabaseManage.GetColumn(sqlDatabase.tbCars, "Renter", ("Id", CmbID.Text))[0];
                ...
                if (DatabaseManage.IsThere(sqlDatabase.tbCustomers, "Name", "=", ("Name", name), ("Surname", surname), ("Renter", "1")) && renter != "NULL" && renter != DatabaseManage.GetColumn(sqlDatabase.tbCars, "Renter", ("Id", CmbID.Text))[0])
                {
        ...
        private void CmbID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            TxtLastRenter.Text = DatabaseManage.GetColumn(sqlDatabase.tbCars, "LastRenter", ("Id", CmbID.Text))[0];
