...
namespace AracKiralama
{
    public class SqlDatabase
    {
        ...
        public readonly string db = "AracKiralama", tbLogin = "Login", tbCars = "Cars", tbCustomers = "Customers";
        #endregion
            ...
            string Rented, string Renter, string RentDate, string Delivered,string DeliveredDate, string DeliveryDate, string LastRenter)
        {
            try
            {
                // Müşteri Güncelleştirmeleri
                using SqlConnection con = new(_ConnectionString);
                // Yeni kiralayan müşterinin güncellenmesi
                ...
                // Eski kiralayan müşterinin güncellenmesi
            ...
            string RentedModel, string RentDate, string Delivered, string DeliveredDate,string DeliveryDate, string LastRentedModel)
        {
            try
            {
                using (SqlConnection con = new(_ConnectionString))
                {
                    // Yeni kiralanan aracın güncellenmesi
                    ...
                    // Son kiralanan aracın güncellenmesi
