    ...
    public partial class FrmEditCars : Form
    {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (SqlDatabase.IsThere(SqlDatabase.dbAracKiralama, SqlDatabase.tbCustomers, "Name", "=", 3, "Name", name, "Surname", surname, "Renter", "1") && renter != "NULL" && renter != SqlDatabase.GetColumn(SqlDatabase.dbAracKiralama, SqlDatabase.tbCars, "Renter", 1, "Id", CmbID.Text)[0])
                {
        ...
        private void CmbID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            CmbRenter.Text = SqlDatabase.GetColumn(SqlDatabase.dbAracKiralama, SqlDatabase.tbCars, "Renter", 1, "Id", CmbID.Text)[0] == "" ? "Yok" : SqlDatabase.GetColumn(SqlDatabase.dbAracKiralama, SqlDatabase.tbCars, "Renter", 1, "Id", CmbID.Text)[0];
