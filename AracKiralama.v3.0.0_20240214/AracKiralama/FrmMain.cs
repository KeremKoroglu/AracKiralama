...
namespace AracKiralama
{
    public partial class FrmMain : Form
    {
        ...
        readonly FrmIdleCarList IdleCarList = new();
        readonly FrmRentedCarList RentedCarList = new();
        readonly FrmCustomerList CustomerList = new();
        readonly FrmRenterCustomersList RenterCustomerList = new();
        readonly FrmAddCar AddCar = new();
        readonly FrmRentCar RentCar = new();
        readonly FrmAddCustomer AddCustomer = new();
        readonly FrmEditCars EditCars = new();
        readonly FrmEditCustomers EditCustomers = new();
        readonly FrmPaySystem PaySystem = new();
        #endregion
        ...
        {
            BtnAddCustomer.BackColor = SystemColors.ActiveBorder;
        }
