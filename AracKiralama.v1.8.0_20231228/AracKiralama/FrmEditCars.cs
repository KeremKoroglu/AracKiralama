    ...
    public partial class FrmEditCars : Form
    {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (SqlDatabase.IsThere(SqlDatabase.dbAracKiralama, SqlDatabase.tbCustomers, "Name", "=", 2, "Name", name, "Renter", "1") && SqlDatabase.IsThere(SqlDatabase.dbAracKiralama, SqlDatabase.tbCustomers, "Name", "=", 1, "RentedModel", model) == false)
                {
                ...
                if (TxtRenter.Text != null)
                {
                    command = "USE AracKiralama UPDATE Customers SET Renter = 1, RentedModel = '" + TxtNewModel.Text + "', RentDate = " + rentDate + ", Delivered = 0, DeliveredDate = NULL, DeliveryDate = " + deliveryDate + " WHERE Name = '" + name + "'";
                    SqlDatabase.RunCommand(command);
                }
